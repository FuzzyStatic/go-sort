...
* @Last modified time: 2017-02-20T22:27:53-05:00
 */
...
func TestSelectionSort(t *testing.T) {
	slice1 := &[]int{9, 8, 7, 6, 5, 4, 3, 2, 1}
	t.Logf("Test selection sort of %v", *slice1)
	s1, _ := New(slice1)
	s1.SelectionSort()
	...
	slice2 := &[]int{6, 5, 4, 4, 8, 7, 7, 2, 1}
	t.Logf("Test selection sort of %v", *slice2)
	s2, _ := New(slice2)
	s2.SelectionSort()
	...
	slice3 := &[]int{9, 1, 8, 2, 7, 3, 6, 4, 5}
	t.Logf("Test selection sort of %v", *slice3)
	s3, _ := New(slice3)
	s3.SelectionSort()
...
func TestQuickSort(t *testing.T) {
	slice1 := &[]int{9, 8, 7, 6, 5, 4, 3, 2, 1}
	t.Logf("Test quick sort of %v", *slice1)
	s1, _ := New(slice1)
	s1.QuickSort(0, len(*slice1)-1) // Start at 0 and go to the last index value
	...
	slice2 := &[]int{6, 5, 4, 4, 8, 7, 7, 2, 1}
	t.Logf("Test quick sort of %v", *slice2)
	s2, _ := New(slice2)
	s2.QuickSort(0, len(*slice2)-1) // Start at 0 and go to the last index value
	...
	slice3 := &[]int{9, 1, 8, 2, 7, 3, 6, 4, 5}
	t.Logf("Test quick sort of %v", *slice3)
	s3, _ := New(slice3)
	s3.QuickSort(0, len(*slice3)-1) // Start at 0 and go to the last index value
